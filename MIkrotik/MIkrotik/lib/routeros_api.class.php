        ...
        if (is_array($response)) {
            ...
            foreach ($response as $x) {
                if (in_array($x, array('!fatal','!re','!trap'))) {
                    if ($x == '!re') {
                        $PARSED[] = 'valor';  // Agrega un nuevo valor al arreglo
$lastIndex = count($PARSED) - 1; // Obtén el índice del último elemento agregado
$CURRENT =& $PARSED[$lastIndex]; // Ahora, puedes referenciar ese índice directamente
